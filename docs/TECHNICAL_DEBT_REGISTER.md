...
| **Критичність** | Високий |
| **Локація** | Системна залежність `pip` у CI/Dockerfile/Makefile |
...
| **Ризик** | Середній (використовуються лише довірені джерела); мітіговано вимогою `pip>=25.3` |
| **Власник** | @devops |
...
| **Статус** | ✅ Мітіговано (pip>=25.3 застосовано в CI, Dockerfile, Makefile) |
| **Докази** | `pip-audit --requirement requirements.txt --progress-spinner=off` → 0 вразливостей; CI `ci-neuro-cognitive-engine.yml` job `dependency-drift` + pip>=25.3 у всіх workflow кроках |
