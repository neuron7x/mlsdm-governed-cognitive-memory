...
def main() -> None:
    """Deprecated legacy shim; delegates to the cloud entrypoint."""
    warnings.warn(
        "mlsdm.service.neuro_engine_service is deprecated; use `mlsdm entrypoints.cloud` "
        "or `mlsdm serve` instead.",
        DeprecationWarning,
        stacklevel=2,
    )
